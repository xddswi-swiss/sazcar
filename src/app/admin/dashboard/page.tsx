...
export default async function DashboardPage() {
  ...
  // Fetch recent active projects (last 5)
                ...
                <div key={proj.id} className="p-5 flex items-center justify-between hover:bg-slate-50/50 dark:hover:bg-slate-700/20 transition-all">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Link
                      ...
                      className="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-white"
                    >
