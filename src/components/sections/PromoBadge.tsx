...
const badgeTheme = {
  winter_tires: { iconBg: 'bg-sky-100/90', iconText: 'text-sky-600', label: 'text-sky-600', cta: 'bg-sky-600 hover:bg-sky-700 text-white', border: 'border-sky-200/80', glow: 'from-sky-500/20 via-sky-400/10 to-transparent', bg: 'from-sky-50/90 via-white to-sky-50/30', badge: 'bg-sky-100 text-sky-700 border-sky-200', dot: 'bg-sky-500' },
  summer_tires: { iconBg: 'bg-amber-100/90', iconText: 'text-amber-600', label: 'text-amber-600', cta: 'bg-amber-600 hover:bg-amber-700 text-white', border: 'border-amber-200/80', glow: 'from-amber-500/20 via-orange-400/10 to-transparent', bg: 'from-amber-50/90 via-white to-amber-50/30', badge: 'bg-amber-100 text-amber-700 border-amber-200', dot: 'bg-amber-500' },
  detailing: { iconBg: 'bg-violet-100/90', iconText: 'text-violet-600', label: 'text-violet-600', cta: 'bg-violet-600 hover:bg-violet-700 text-white', border: 'border-violet-200/80', glow: 'from-violet-500/20 via-purple-400/10 to-transparent', bg: 'from-violet-50/90 via-white to-violet-50/30', badge: 'bg-violet-100 text-violet-700 border-violet-200', dot: 'bg-violet-500' },
  service: { iconBg: 'bg-red-100/90', iconText: 'text-red-600', label: 'text-red-600', cta: 'bg-red-600 hover:bg-red-700 text-white', border: 'border-red-200/80', glow: 'from-red-500/20 via-rose-400/10 to-transparent', bg: 'from-red-50/90 via-white to-rose-50/30', badge: 'bg-red-100 text-red-700 border-red-200', dot: 'bg-red-500' },
  custom: { iconBg: 'bg-emerald-100/90', iconText: 'text-emerald-600', label: 'text-emerald-600', cta: 'bg-emerald-600 hover:bg-emerald-700 text-white', border: 'border-emerald-200/80', glow: 'from-emerald-500/20 via-teal-400/10 to-transparent', bg: 'from-emerald-50/90 via-white to-emerald-50/30', badge: 'bg-emerald-100 text-emerald-700 border-emerald-200', dot: 'bg-emerald-500' },
} as const;
